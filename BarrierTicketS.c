...
// Local Variables: //
// compile-command: "gcc -Wall -Wextra -std=gnu11 -O3 -DNDEBUG -fno-reorder-functions -DPIN -DBARRIER -DAlgorithm=BarrierTicketS Harness.c -lpthread -lm -D`hostname` -DCFMT" //
// End: //
